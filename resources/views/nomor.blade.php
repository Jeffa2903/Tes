            ...
            <nav class="navbar bg-body-tertiary">
              ...
              <div class="log-in mt-5 mb-5 -center mx-auto" style="width: 40%; height: 100%;">
                    ...
                    <div class="mb-3 text-center">
                      <label class="form-label"><h1> {{ $t }}</h1><br></label>
                    </div>
                    <div class="mb-3 text-center">
                    ...
                    <div class="mb-3 text-center">
                      ...
                      <br>
                      <div class="mb-3 text-center">
                        <label class="form-label">*Silahkan Screenshot untuk Check In</label>

                      </div>

                      <form action="{{ url('/') }}">
                      <button class="btn btn-primary form-control">Kembali ke halaman Pemesanan</button>
                      </form>
